...
/**
 * @see http://svn.symfony-project.com/plugins/zxI18nRoutingPlugin/branches/1.4/README
 */
class IcePatternI18nRouting extends sfPatternRouting
{
  /**
  ...
  public function connect($name, $route)
  {
    ...
    if (!isset($options['IceI18nRouting']))
    {
