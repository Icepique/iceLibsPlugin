...
class sfWidgetFormSelectDoubleList extends sfWidgetForm
{
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    if ($associated_first)
    {
      $associate_image = 'fatcow/16x16/arrow_left.png';
      $unassociate_image = 'fatcow/16x16/arrow_right.png';
      $float = 'left';
    }
    else
    {
      $associate_image = 'fatcow/16x16/arrow_right.png';
      $unassociate_image = 'fatcow/16x16/arrow_left.png';
      $float = 'right';
    }

    $this->addOption('unassociate', '<img src="/assets/images/icons/'.$unassociate_image.'" alt="unassociate" />');
    $this->addOption('associate', '<img src="/assets/images/icons/'.$associate_image.'" alt="associate" />');
...
EOF
  ...
  {
    return array('/assets/js/doublelist.js');
  }
