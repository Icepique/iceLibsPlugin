...
<script type="text/javascript">
  ...
  {
    jQuery("#%s").autocomplete('%s', jQuery.extend({},
    {
      dataType: 'json',
      parse: function(data)
      {
        ...
        for (key in items)
        {
          parsed[key] = { data: [ items[key].name, items[key].id ], value: items[key].name, result: items[key].name };
        }
...
EOF
  ...
  {
    return array('/assets/css/jquery/autocomplete.css' => 'all');
  }
  ...
  {
    return array('/assets/js/jquery/autocomplete.js');
  }
}
