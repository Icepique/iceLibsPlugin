 ...
 * @subpackage strings
 */
function utf8_strlen($str, $encoding = 'UTF-8')
{
 ...
 * @subpackage strings
 */
function utf8_substr($str, $offset, $length = null, $encoding = 'UTF-8')
{
  if ($length === null) {
 ...
 * @subpackage strings
 */
function utf8_strtolower($str, $encoding = 'UTF-8')
{
 ...
 * @subpackage strings
 */
function utf8_strtoupper($str, $encoding = 'UTF-8')
{
