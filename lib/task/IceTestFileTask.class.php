...
class IceTestFileTask extends sfTestBaseTask
{
  /**
   * @see sfTask
   */
  protected function configure()
  {
    ...
    $this->namespace = 'test';
    $this->name = 'file';
    $this->briefDescription = 'Launches tests defined on the command line';

    $this->detailedDescription = <<<EOF
The [test:file|INFO] task launches tests defined on the command line:

  [./symfony test:file|INFO]

The task launches tests defined on the command line.
